...
module tb_data_assembler_160;
    ...
    initial begin
        ...
        write_word(32'hCCCC0005);
        write_word(32'hCCCC0006);
        write_word(32'hCCCC0007);
        write_word(32'hCCCC0008);
        read_data();
        #10;
        $display("Data_out = %h", data_out);
